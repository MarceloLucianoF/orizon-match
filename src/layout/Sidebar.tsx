      ...
      <nav className="flex-1 p-4 overflow-y-auto custom-scrollbar">
        ...
        {isActualAdmin && (
          <div className="mb-6 px-3">
            <p className="text-[10px] font-bold text-teal-500 uppercase tracking-widest mb-2 flex items-center gap-2">
            ...
            <select
              ...
              className="w-full bg-slate-950 border border-slate-800 text-[11px] text-slate-300 rounded-lg px-3 py-2 outline-none focus:border-teal-500 transition-all font-semibold"
            >
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-3 px-3 py-3 rounded-xl transition-all duration-200 min-w-0 ${
                    isActive
                      ? "bg-teal-500/10 text-teal-300 border border-teal-500/20 shadow-[0_0_10px_rgba(0,181,156,0.1)]"
        ...
        {isActualAdmin && currentRole !== 'admin' && (
          <div className="pt-4 border-t border-slate-800">
            <p className="px-3 text-[10px] font-bold text-teal-500 uppercase tracking-widest mb-2 flex items-center gap-2">
              ...
              <Link
                ...
                className={`flex items-center gap-3 px-3 py-3 rounded-xl transition-all duration-200 min-w-0 ${
                  pathname.startsWith('/admin')
                      ? "bg-teal-500/10 text-teal-300 border border-teal-500/20 shadow-[0_0_15px_rgba(0,181,156,0.1)]"
                      : "text-slate-400 hover:bg-slate-800/50 hover:text-slate-200 border border-transparent"
                }`}
              >
                <ShieldAlert size={20} />
