    ...
    <div className="bg-[#030712] text-slate-100 min-h-screen overflow-x-hidden selection:bg-indigo-500/30 selection:text-indigo-200">
      ...
      <header className="fixed top-0 w-full z-50 bg-slate-950/70 backdrop-blur-md border-b border-slate-800/60 transition-all duration-300">
        <div className="max-w-6xl mx-auto px-4 md:px-6 py-3.5 flex justify-between items-center">
          <Link to="/" className="font-black text-xl text-white tracking-tight flex items-center gap-2.5 group">
            <Logo className="w-8 h-8 text-primary shadow-[0_0_15px_rgba(0,181,156,0.4)] group-hover:scale-105 group-hover:rotate-3 transition-all duration-300" />
            InovaHelix <span className="text-primary text-xs font-semibold px-2 py-0.5 rounded bg-slate-900 border border-slate-800 tracking-wider">PLATFORM</span>
          </Link>
          <div className="flex gap-4 items-center">
            ...
            <Link to="/onboarding" className="px-4 py-2 rounded-xl bg-gradient-to-r from-teal-600 to-teal-500 hover:from-teal-500 hover:to-teal-450 transition-all duration-300 font-semibold text-white text-sm shadow-[0_0_15px_rgba(0,181,156,0.3)] hover:shadow-[0_0_20px_rgba(0,181,156,0.5)] hover:-translate-y-0.5 active:translate-y-0">
              Cadastrar
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6 py-20 md:py-24">
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5">
              <span className="text-xs font-bold uppercase tracking-[0.2em] text-teal-400">Matchmaking de Precisão</span>
            ...
            <div className="lg:col-span-7 bg-slate-900/60 border border-slate-800/80 rounded-3xl p-6 shadow-2xl relative overflow-hidden backdrop-blur-md hover:border-teal-500/10 transition-all duration-500 group/sim">
              <div className="absolute top-0 right-0 w-48 h-48 bg-teal-500/[0.02] blur-[80px] pointer-events-none" />
              <div className="flex items-center justify-between pb-4 border-b border-slate-800 mb-6">
                <span className="text-xs font-bold text-slate-400 tracking-wider">Mecanismo de IA InovaHelix</span>
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-center gap-3 py-1">
                  ...
                  <div className="px-3 py-1 rounded-full bg-teal-500/20 text-teal-300 text-[10px] font-mono font-bold flex items-center gap-1.5 shadow-sm">
                ...
                {/* Match Result Card */}
                <div className="bg-teal-950/20 p-4 rounded-xl border border-teal-500/30 flex justify-between items-start gap-4 hover:border-teal-500/50 hover:shadow-[0_0_20px_rgba(20,184,166,0.1)] transition-all duration-300">
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      <GraduationCap className="text-teal-400 w-4 h-4" />
                      <span className="text-[10px] font-bold text-teal-300 uppercase">Universidade Federal de Minas Gerais (UFMG)</span>
                    </div>
                    ...
                    <div className="flex gap-3 text-[10px] pt-1">
                      <span className="bg-slate-900 border border-slate-800 px-2 py-0.5 rounded text-teal-300 font-semibold">TRL 6 (Modelo Funcional)</span>
                  ...
                  <div className="text-right shrink-0">
                    ...
                    <span className="text-2xl md:text-3xl font-black text-teal-400 drop-shadow-[0_0_8px_rgba(20,184,166,0.5)]">92%</span>
                    <span className="block mt-2 px-2 py-1 bg-teal-500/20 text-teal-300 text-[9px] font-bold rounded uppercase tracking-wider text-center">
                      Recomendado
                    </span>
                  </div>
                </div>
      ...
      <section className="max-w-6xl mx-auto px-4 md:px-6 py-20 md:py-24">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="text-xs font-bold uppercase tracking-[0.2em] text-teal-400">Por que a InovaHelix?</span>
          <h2 className="text-3xl md:text-4xl font-black text-white tracking-tight mt-2 mb-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          {/* InovaHelix */}
          <div className="bg-teal-550/5 border border-teal-500/20 rounded-3xl p-6 md:p-8 shadow-[0_0_30px_rgba(0,181,156,0.05)]">
            <h3 className="font-bold text-teal-400 text-lg mb-6 flex items-center justify-between">
              Com InovaHelix
      ...
      <section className="max-w-6xl mx-auto px-4 md:px-6 py-20 md:py-28 relative">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="text-xs font-bold uppercase tracking-[0.2em] text-teal-400">Tudo em um só lugar</span>
          <h2 className="text-3xl md:text-4xl font-black text-white tracking-tight mt-2 mb-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div 
              key={title} 
              className="bg-slate-900/40 border border-slate-800/80 hover:border-teal-500/20 hover:shadow-[0_12px_24px_-8px_rgba(20,184,166,0.06)] hover:-translate-y-0.5 rounded-2xl p-6 transition-all duration-300 backdrop-blur-sm shadow-sm"
            >
      ...
      <section className="text-center py-24 md:py-36 px-4 md:px-6 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-white tracking-tight leading-tight mb-4">
            ...
            <span className="text-teal-400">com total segurança.</span>
          </h2>
          ...
          <Link
            to="/onboarding"
            className="group inline-flex items-center gap-3 px-8 md:px-10 py-4 md:py-5 rounded-2xl bg-gradient-to-r from-teal-600 to-teal-500 hover:from-teal-500 hover:to-teal-450 transition-all duration-300 font-bold text-base md:text-lg text-white shadow-[0_0_30px_rgba(0,181,156,0.4)] hover:shadow-[0_0_40px_rgba(0,181,156,0.6)] hover:-translate-y-0.5 active:translate-y-0 active:scale-95"
          >
      ...
      <footer className="border-t border-slate-800/50 py-8 text-center text-slate-500 text-xs md:text-sm px-4">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          <span className="font-bold text-white">InovaHelix</span>
          <p>© 2026 InovaHelix · Plataforma de Transferência Tecnológica Segura · <Link to="/sobre" className="hover:text-slate-300 transition">Sobre</Link></p>
        </div>
      </footer>
